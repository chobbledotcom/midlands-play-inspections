...
blocks:
  - type: split-icon-links
    dark: true
    compact: false
    subtitle: Midland Play Inspections
    content: |-
      ...
      fixed price and the next free date.
    reverse: false
    button:
