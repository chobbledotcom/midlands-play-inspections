...
blocks:
  - type: hero
    ...
    content: |-
      ...
      sets the unit up and watches it, and that is where most of the risk
      actually sits.
    buttons:
  ...
  - type: split-callout
    ...
    content: |-
      ...
      Check the right blower is attached and the connection tube is done up
      properly. Walk the unit and look for rips, holes and anything that has
      come unstitched since last time. Stand back and look at the shape of it,
      because a wall that sags or a unit that is visibly lopsided is telling you
      something about the pressure or a seam.

      Check the blower fan is clear of grass and debris and that the non-return
      flap works. Put a manometer on it and compare the reading against what the
      manufacturer specifies rather than against what it feels like underfoot.
  ...
  - type: split-full
    ...
    left_content: |-
      ...
      for the whole time an inflatable is in use. That means somebody whose job
      is watching it, not somebody running the barbecue who can see it from
    ...
    right_content: |-
      ...
      happen it is the difference between a defensible position and your word
      against theirs.

      Keep the current inspection report with the unit or somewhere you can get
      at it from your phone, because venues ask. Keep the manufacturer's
      operating instructions too. If the unit came without them, or the
      manufacturer has gone, you may need an operations manual putting together
      for it, and that is worth sorting before an inspection rather than during.
    right_button:
