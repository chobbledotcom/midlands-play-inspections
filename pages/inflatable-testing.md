...
blocks:
  - type: hero
    badge: Annual inspections
    content: |
      # PIPA testing and RPII inspections, explained properly

      An annual inspection isn't a rubber stamp. Here's exactly what gets
      checked, what you're handed at the end, and what happens if something
      doesn't pass.
    buttons:
      - text: Book yours
        href: /contact/
  ...
  - type: split-html
    ...
    content: |
      ## A tag on the unit, a report in your inbox

      Every unit that passes gets a **PIPA tag** fitted, which is the closest thing an
      inflatable has to a number plate. Anyone can look that tag up on the PIPA
      database and see a live inspection status, which is what a school, a
      council or a venue booking officer will do.

      Alongside it you get a **PDF inspection report**: the unit identified by
      make, serial and size, every check point recorded, photographs of anything
      of note, and a plain-English summary. It's written to be forwarded, so send
      it straight to your insurer or a venue without having to explain it.

      Units that fall outside the PIPA scheme get the equivalent EN 14960 or
      bespoke inspection and a report in the same format, just without a tag.
    button:
    ...
    figure_html: |
      <div class="report-card">
        <div class="report-card__head">
          <div>
            <div class="report-card__title">Inspection report</div>
            <div class="report-card__sub">BS EN 14960-1:2019 &middot; illustrative extract</div>
          </div>
          <div class="report-card__tag">Pass</div>
        </div>
        <ul>
          <li><span>Anchorage: points, straps &amp; pegs</span><span class="report-card__pass">&check;</span></li>
          <li><span>Seams, stitching &amp; fabric condition</span><span class="report-card__pass">&check;</span></li>
          <li><span>Operating pressure &amp; air loss</span><span class="report-card__pass">&check;</span></li>
          <li><span>Wall heights &amp; containment netting</span><span class="report-card__pass">&check;</span></li>
          <li><span>Entrapment &amp; finger-trap checks</span><span class="report-card__pass">&check;</span></li>
          <li><span>Blower, ducting &amp; electrical (PAT)</span><span class="report-card__pass">&check;</span></li>
        </ul>
      </div>
  ...
  - type: section-header
    intro: |
      ...
      Well over 140 individual check points on a standard castle, grouped into
      six areas. Bigger and more complex units carry more.

  - type: features
    items:
      - icon: "hugeicons:anchor-point"
        name: Anchorage
        description: Number, position and strength of anchor points; straps, ropes and ground pegs; ballast where pegging isn't possible.
      - icon: "hugeicons:layers-01"
        name: Fabric and seams
        description: Stitching, seam integrity, abrasion, UV damage, repairs and patches, netting condition and mesh size.
      - icon: "hugeicons:dashboard-speed-01"
        name: Pressure and air loss
        description: Operating pressure under load, blower sizing and duty, air-loss points and how the unit behaves as it fills.
      - icon: "hugeicons:ruler"
        name: Dimensions and heights
        description: Wall heights against platform heights, fall heights, step and slide geometry, impact areas and clearances.
      - icon: "hugeicons:alert-02"
        name: Entrapments
        description: Head, neck, finger and limb entrapment probes across every gap, opening, arch and net junction.
      - icon: "hugeicons:plug-socket"
        name: Blower and electrics
        description: Blower guard and condition, ducting, cable and plug inspection, and PAT testing of the blower and lead.
  ...
  - type: split-full
    ...
    left_content: |
      ...
      A brand-new unit needs an initial inspection before it earns anything.
      It's the baseline the annual checks are measured against. If you're buying
      new or importing, get it looked at before it goes out, not after a venue
    ...
    right_content: |
      ...
      Got more than a handful of units? A fleet day works out far cheaper per
      unit than booking them one at a time. We come to your storage for a full
      day and work through everything you've got, tagging as we go.
    right_button:
